...
export const getSearchPanelWidthWithResizeBar = state => state.viewer.panelWidths.searchPanel + (state.viewer.disabledElements.searchPanelResizeBar ? 0: RESIZE_BAR_WIDTH);
