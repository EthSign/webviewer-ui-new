...
export default {
  viewer: {
    ...
    disabledElements: {
      ...
      caseSensitiveSearchOption: { disabled: true, priority: 2 },
      wholeWordSearchOption: { disabled: true, priority: 2 },
      thumbnailsSizeSlider: { disabled: true, priority: 2 },
      documentControl: { disabled: true, priority: 2 },
      thumbnailControl: { disabled: true, priority: 2 },
      searchPanelResizeBar: { disabled: true, priority: 2 },
    ...
    headers: {
      ...
      'toolbarGroup-Measure': [
        ...
        {
          type: 'toolGroupButton',
          toolGroup: 'arcMeasurementTools',
          dataElement: 'arcMeasurementToolGroupButton',
